<script lang="ts">
	...
	// PadelIndex — /rating
	// ============================================================
	// Bis Block 4 des Website-Audits waren Simulator, Sicherheit,
	// Verlauf und Vergleich Anker-Abschnitte auf der Startseite — Google
	// konnte sie nicht getrennt von "PadelIndex — Dein Level" ranken.
